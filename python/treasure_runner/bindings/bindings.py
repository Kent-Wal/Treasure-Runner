...
# Opaque pointer type for Player and GameEngine
...
# game engine lifecycle bindings
...
# game engine operations bindings
...
lib.game_engine_get_charset.argtypes = [GameEngine, ctypes.POINTER(Charset)]
lib.game_engine_get_charset.restype = Status
...
lib.game_engine_can_enter_portal_at.argtypes = [GameEngine, ctypes.c_int, ctypes.c_int, ctypes.POINTER(ctypes.c_bool)]
lib.game_engine_can_enter_portal_at.restype = Status

lib.game_engine_get_room_ids.argtypes = [GameEngine, ctypes.POINTER(ctypes.POINTER(ctypes.c_int))]
lib.game_engine_get_room_ids.restype = Status

lib.game_engine_reset.argtypes = [GameEngine]
lib.game_engine_reset.restype = Status

lib.game_engine_get_treasure_stats.argtypes = [GameEngine, ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
lib.game_engine_get_treasure_stats.restype = Status
